          ...
          <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-0 lg:px-8">
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-5xl">
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div>
                  <button className="flex w-full justify-center rounded-md bg-[#00dc94] px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-[#00dc94] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">
                    Deploy
                  </button>
                </div>
              </form>
